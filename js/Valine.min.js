              ...
              if ((p = p instanceof HTMLElement ? p : f[f.length - 1] || null)) {
                ...
                var v = (0 == e.config.meta.length
                  ...
                  g =
                    ...
                    e.i18n.t("more") +
                    '</button></div><div class="vpower txt-right"</a><br>v' +
                    h.VERSION +
                    "</div>";
                e.$el.html(g),
